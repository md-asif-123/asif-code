...
<div class="header">
	<div class="col-lg-1 col-md-2 col-sm-2 col-xs-12">
        <div id="logo">
           <a href="http://localhost/leadgenerator/backend/index/dashboard">  <img src="<?php echo base_url(); ?>/assets/images/leadtool-small-logo.png" class="img-responsive"></a>
        </div>
    </div>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li><a href="<?php echo base_url(); ?>index.php/index/map">by pie chart</a></li>
