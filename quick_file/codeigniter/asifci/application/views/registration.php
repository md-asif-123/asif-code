...
<form action="<?php echo base_url();?>index.php/index/user_add" method="post">
...
<tr><td>Choose Hobby</td><td>
<input type='checkbox' name='hobby[]' value='Math' />Math
<input type='checkbox' name='hobby[]' value='Physics' />Physics
<input type='checkbox' name='hobby[]' value='Chemistry' />Chemistry
</td></tr>
