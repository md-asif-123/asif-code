        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
			<div class="oder-quntity">
            	<span class="imp-text">Oder Quntity</span><br>
                	<input type='text' name='quantity' id='quant' value='' placeholder='quantity'/><br><br>
					<input type='text' id="datepicker" name='date' value='' placeholder='date'/>
        	...
        	<form class="form">
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
                ...
                <input type="text" class="form-control" name="product1" value="" id="pd1" placeholder="Product Name">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <input type="text" class="form-control" name="quantity1" id="qnt1" placeholder="Average Quantity">
                  </div>
              </div>
              ...
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
                    <input type="text" class="form-control" name="quantity2" id="qnt2" placeholder="Average Quantity">
                  </div>
              </div>
              ...
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
                    <input type="text" class="form-control" name="quantity3" id="qnt3" placeholder="Average Quantity">
                  </div>
              </div>
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
              	<div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <input type="text" class="form-control" name="product4" id="pd4" placeholder="Product Name">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
                    <input type="text" class="form-control" name="quantity4" id="qnt4" placeholder="Average Quantity">
                  </div>
              </div>
            </form>
        </div>
...
<div id='btn2'>
<input type='submit' value='SEND' class="send-button" name="submit" id='b2'/>
</div>

</div>
        <div id="btn33" >
<div id='btn2'>
<input type='submit' value='SEND' class="send-button" name="submit" id='b3'/>
</div>
