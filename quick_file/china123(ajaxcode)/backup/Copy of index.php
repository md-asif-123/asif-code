...
<section class="regform">
	<div class="container">
		...
		<input type="text" name="firstname" value="<?php echo $firstname ?>" class="form-control" id="Surname" placeholder="Name" <?php if(!$_REQUEST['stat']){echo "disabled" ;}else {echo "enabled";} ?>/>
			  </div>
			  
			  <div class="form-group col-lg-6 col-md-6 col-xs-12">
				<label for="exampleInputEmail1">E-mail</label>
				<input type="email" name="email" value="<?php echo $email ?>" class="form-control" id="email" placeholder="E-mail"  <?php if(!$_REQUEST['stat']){echo "disabled" ;}else {echo "enabled";} ?>/>
			  </div>
			  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
				<label for="exampleInputPassword1">Phone Number</label>
				<input type="text" name="mobile_no" value="<?php echo $mobile_no ?>" class="form-control" id="exampleInputSurname" placeholder="Phone Number"  <?php if(!$_REQUEST['stat']){echo "disabled" ;}else {echo "enabled";} ?>/>
