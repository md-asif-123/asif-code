...
<section class="red-area">
	<div class="container">
		...
		<input type='text' value='' name='mobile_no1' id='mobile1'/>
		 <input type='submit' value='SUBMIT' class="btn btn-default" name="submit1" id='r3' />
...
<section class="regform">
	<div class="container">
		...
		<input type="text" name="firstname" value="<?php echo $firstname ?>" class="form-control" id="fname" placeholder="Name" />
			  </div>
			  ...
			  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
				...
				<input type="text" name="mobile_no" value="<?php echo $mobile_no ?>" class="form-control" id="mobile" placeholder="Phone Number" />
        ...
        <div class="product-form">
        	<form class="form">
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
              	<div class="form-group col-lg-6 col-md-6 col-xs-12">
                <input type="text" class="form-control" name="product1" value="<?php echo $product1 ?>" id="pd1" placeholder="Product Name">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
              ...
              <div class="one-form col-md-12 col-xs-12 col-sm-12">
              	<div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <input type="text" class="form-control" name="product2" value="<?php echo $product2 ?>" id="pd2" placeholder="Product Name">
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
