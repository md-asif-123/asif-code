	...
	<div class="container">
		...
		<input type="text" name="firstname1" value="" class="form-control" id="fname1" placeholder="Name" />
			  ...
			  <div class="form-group col-lg-6 col-md-6 col-xs-12 ">
				...
				<input type="text" name="mobile_no1" value="" class="form-control" id="mobile1" placeholder="Phone Number" />
...
<div id='btn2'>
<input type='submit' value='SEND2' class="send-button" name="submit" id='b2'/>
</div>
