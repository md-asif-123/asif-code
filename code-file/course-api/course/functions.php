...
function my_action() {
    ...
    foreach($results1 as $key=>$result):
        if($key == $count1 && $count1 < $count+5):
        $html .= '<a target="_blank" href=http://demo-asif.lovestoblog.com/'.$result->wp_url.'><img src=https://learn.docmode.org'.$result->media->course_image->uri.' height="500px" width="400px"></a>'."<br>";
